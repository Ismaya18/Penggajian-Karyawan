	...
	<div class="card mb-3">
		...
		<div class="card-body">
			...
			<form class="form-inline">
				...
				<a href="<?php echo base_url('admin/dataAbsensi/inputAbsensi') ?>" class="btn btn-success  mb-2 ml-3"><i class="fas fa-plus"></i> Input Absensi</a>
			</form>
	...
	if ($jml_data > 0) { ?>
		...
		<table class="table table-bordered table-striped">
			<tr>
				...
				<td class="text-center">Kode Pegawai</td>
